        ...
        <header className="bg-white shadow-md sticky top-0 z-10">
            <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-6">
                    <a href="#/" onClick={() => setRoute({ name: 'home' })} className="text-gray-600 hover:text-blue-600">Home</a>
                    <a href="#/cart" onClick={() => setRoute({ name: 'cart' })} className="relative text-gray-600 hover:text-blue-600">
